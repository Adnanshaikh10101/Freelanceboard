  ...
  <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
    ...
    <div>
      ...
      <div className="flex gap-4 mt-4 text-xl">
        <a className="hover:text-fuchsia-400 cursor-pointer" href="https://youtube.com" target="_blank" rel="noreferrer">🌐</a>
        <a className="hover:text-fuchsia-400 cursor-pointer" href="https://www.youtube.com">🐦</a>
        <a className="hover:text-fuchsia-400 cursor-pointer" href="https://www.youtube.com">💼</a>
      </div>
    </div>
